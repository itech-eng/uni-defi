...
const FeaturesSection = () => {
  return (
    <div className="mx-auto  rounded-3xl shadow-[0_10px_50px_5px_#7e22ce4a] shadow-primary/40 my-6 bg-slate-950 border border-slate-900 py-32 max-w-7xl px-4 sm:px-6   lg:px-8">
